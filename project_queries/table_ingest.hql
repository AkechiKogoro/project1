CREATE DATABASE IF NOT EXISTS clean_taxi;
USE clean_taxi;
...
CREATE EXTERNAL TABLE IF NOT EXISTS sample_for_hire_vehicle (
    dispatching_base_num STRING,
    PUlocationID INT,
    DOlocationID INT,
    affiliated_base_number STRING,
...
FIELDS TERMINATED BY ','
STORED AS TEXTFILE
LOCATION "hdfs://ip-172-31-3-80.eu-west-2.compute.internal:8020//user//ec2-user//UKUSJULHDFS//yesheng//clean_data//small_dataset//sample_for_hire_vehicle//";
...
CREATE EXTERNAL TABLE IF NOT EXISTS sample_yellow_taxi (
    vendorID INT,
    passenger_count INT,
    trip_distance FLOAT,
    RatecodeID INT,
...
FIELDS TERMINATED BY ','
STORED AS TEXTFILE
LOCATION "hdfs://ip-172-31-3-80.eu-west-2.compute.internal:8020//user//ec2-user//UKUSJULHDFS//yesheng//clean_data//small_dataset//sample_yellow_taxi//";
...
CREATE EXTERNAL TABLE IF NOT EXISTS sample_green_taxi (
    vendorID INT,
    RatecodeID INT,
    PUlocationID INT,
    DOlocationID INT,
...
FIELDS TERMINATED BY ','
STORED AS TEXTFILE
LOCATION "hdfs://ip-172-31-3-80.eu-west-2.compute.internal:8020//user//ec2-user//UKUSJULHDFS//yesheng//clean_data//small_dataset//sample_green_taxi//";
...
CREATE EXTERNAL TABLE IF NOT EXISTS sample_high_volume_fhv (
    hvfhs_license_num STRING, 
    dispatching_base_num STRING, 
    originating_base_num STRING,
    PULocationID INT, 
...
FIELDS TERMINATED BY ','
STORED AS TEXTFILE
LOCATION "hdfs://ip-172-31-3-80.eu-west-2.compute.internal:8020//user//ec2-user//UKUSJULHDFS//yesheng//clean_data//small_dataset//sample_high_volume_for_hire_vehicle//";
